            ...
            select: function (start, end) {
                var calMbox = bootbox.dialog({
                    ...
                    message: '<div class="row">  ' +
                        ...
                        '<form class="form-horizontal"> ' +
                        '<div class="form-group"> ' +
                        '<label class="col-md-4 control-label" for="name">Título do Evento</label> ' +
                        '<div class="col-md-6"> ' +
                        '<input id="event_title" name="evtitle" type="text" value="Event Title" placeholder="Event Title" class="form-control input-md"> ' +
                        '</div> ' +
                        '</div> ' +
                        '<div class="form-group"> ' +
                        '<label class="col-md-4 control-label" for="name">Descrição</label> ' +
                        '<div class="col-md-6"> ' +
                        ...
                        '</div> ' +
                        '<div class="form-group"> ' +
                        '<label class="col-md-4 control-label" for="name">Selcione a Cor</label> ' +
                        '<div class="col-md-6"> ' +
